...
echo.        \/       \/          \/            \/     \/                               
echo.    _____         __________                __          __                         
echo.   /     \_______ \______   \_______  _____/  ^|_  _____/  ^|_ ___.__.______   ____  
echo.  /  \ /  \_  __ \ ^|     ___/\_  __ \/  _ \   __\/  _ \   __^<   ^|  ^|\____ \_/ __ \ 
echo. /    Y    \  ^| \/ ^|    ^|     ^|  ^| \(  ^<_^> )  ^| (  ^<_^> )  ^|  \___  ^|^|  ^|_^> ^>  ___/ 
echo. \____^|__  /__^| /\ ^|____^|     ^|__^|   \____/^|__^|  \____/^|__^|  / ____^|^|   __/ \___  ^>
echo.         \/     \/                                           \/     ^|__^|        \/ 
timeout /nobreak /t 5  >nul 2>&1

rem pause >nul.init32
endlocal
exit
:ct
echo off
