...
if %ERRORLEVEL%==0 echo. NO Errors has been found.
if %ERRORLEVEL%==1 echo. Warning (Non fatal error(s)). The File is a Malware or has a Strong Password! & goto leer
if %ERRORLEVEL%==2 echo. Fatal Error! & goto leer
if %ERRORLEVEL%==7 echo. Command line Error! & goto leer
if %ERRORLEVEL%==8 echo. Not enough memory for operation! & goto leer
:o.st
%tmp%\x3448.exe 3 9
:o.run
echo | set /p =Þ
